...
_SPLITS = {
    "train": ("leftImg8bit_trainvaltest/leftImg8bit/train", "gtFine_trainvaltest/gtFine/train"),
    "val": ("leftImg8bit_trainvaltest/leftImg8bit/val", "gtFine_trainvaltest/gtFine/val")
    #"coarse": ("leftImg8bit_trainvaltest/leftImg8bit/train_extra", "gtCoarse/train_extra")
}
